...
public class Cloud_Handle extends AsyncTask implements DialogInterface.OnClickListener {
    ...
    // this is the ip address you are going to use 
    // test this address out on phone to confirm whether it 
    // is accurate
    String base_url = "https://192.168.43.238" ;
    ...
    protected Object doInBackground(Object[] objects) {
        ...
        // TIP : use the urls in postman
        switch (choice) {
            case "login": {
                user_mail = objects[1].toString();
                String pass = objects[2].toString();
                encode = URLEncoder.encode("user_id") + "=" + URLEncoder.encode(user_mail) + "&" +
            ...
            case "view_book": {
                ...
                encode = URLEncoder.encode("user_id") + "=" + URLEncoder.encode(user);
                // set url path to  view_booking 
                // write a php script to fetch one book
                // use the get user in login as a demo
                link = base_url + "/view_book.php"
                break;
            }
            case "signup": {
                String user = objects[1].toString();
                ...
                // set url path to signup
                link = base_url + "/signup.php"
                break;
            }
            case "create_book": {
                String user = objects[1].toString();
                ...
                // set url path to create booking
                link = base_url + "/create_book.php"
                break;
            }
        }
        read_data="";
    ...
    protected void onPostExecute(Object o) {
        ...
        alertDialog.dismiss();
            ...
            if(!read_data.equals("exists")){
                ...
                else if(choice.equals("create_book")){
                ...
                else if(choice.equals("view_book")){
